...
import 'package:gyros_app/controllers/productDetailController.dart';
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Obx(
                              () => (_homePageController.isLoading.value)
                              ? Center(child: CircularProgressIndicator())
                              :_homePageController.getflashsellproduct?.result == null
                              ? Center(
                            child: Text('No List'),
                          )
                              : Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    PhysicalModel(
                                      ...
                                      ///code go to next screen save product id.......
                                      child: InkWell(
                                        onTap: () async {
                                          ...
                                          ///todo: from here we have to navigate to second screen......14april2023..prince
                                          // ProductDetailController _controller = Get.put(ProductDetailController());
                                          //  _controller.productid =
                                          //      _homePageController.getflashsellproduct!.result![index].id.toString();
                                          //  _controller.getreviewdetailApi();
                                          SharedPreferences pref = await SharedPreferences.getInstance();
                                          pref.setString("##########165", "${_homePageController.getflashsellproduct?.result![index].id}");
                                          _newProductByIdController.getreviewdetailApi();
                                          _newProductByIdController.update();
                                                ...
                                                children: [
                                                  SizedBox(
                                                    ...
                                                    Center(
                                                      child:
                                                      Text(
                                                        '${_homePageController.getflashsellproduct!.result![index].qty1}' +
                                              ...
                                              Container(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () {
                                                    ...
                                                    _carttcontroller.addtocartApi(_homePageController
                                                        .getflashsellproduct!
                                                        .result![
                                                    index]
                                                        .id);
